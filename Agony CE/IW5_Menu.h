...
void BuildMenu()
{
	...
	addOption(&MenuVars, "Show Host", 0, 0, &bShowHost);
	addOption(&MenuVars, "Juggernaut", 0, 0, NULL, &Jug);
	addOption(&MenuVars, "Change Team", 0, 0, NULL, &swapTeams);
	addOption(&MenuVars, "Uninfector", 0, 0, &bUninfector);
	addOption(&MenuVars, "Change Target", 0, 0, &bSwitchTarget);
	addOption(&MenuVars, "Change Class", 0, 0, NULL, &setClass);
	...
	addOption(&MenuVars, "Load Config", 0, 0, NULL, ReadINI, 1);
