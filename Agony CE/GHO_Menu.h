...
void BuildMenu()
{
	...
	addGroup(&MenuVars, "Name", 1, 0, 5);
	addOption(&MenuVars, "Change Name", 1, 0, NULL, doSetName);
	addOption(&MenuVars, "Steal Names", 1, 0, &bStealName);
	addBar(&MenuVars, "Steal Speed", 1, 0, &fStealSpeed, 50, 250, 50);
	addOption(&MenuVars, "Flash Name", 1, 0, &bFlashName);
