...
void BuildMenu()
{
	...
	addOption(&MenuVars, "Tele Kill", 0, 0, &bTeleKill);

	addOption(&MenuVars, "Add Bots", 1, 0, NULL, &addBots);
	addOption(&MenuVars, "Set Ammo", 1, 0, NULL, &InfAmmo);
	addOption(&MenuVars, "Disconnect", 1, 0, NULL, &Disconnect);
	addOption(&MenuVars, "Die", 1, 0, NULL, &NoWillToLive);
