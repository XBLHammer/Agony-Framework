namespace IW4MP
{
#include "IW4_MenuFunc.h"
#include "IW4_Structs.h"
#include "IW4_Functions.h"
#include "IW4_Menu.h"
#include "IW4_ESP.h"
#include "IW4_Aimbot.h"
#include "IW4_Hook.h"
	...
	void Agony_Monitor()
	{
		if (Dvar_GetBool("cl_ingame"))
		{
			...
			if ((addedTestClient > -1))
			{
				char charBuffer[0x200];
				Sleep(150);
				sprintf(charBuffer, "mr %i 3 autoassign", *(int *)0x8360922C);
				SV_ExecuteClientCommand((void *)(*(int *)0x83623B98 + (addedTestClient * 0x97F80)), charBuffer, 1, 0);
				Sleep(150);
