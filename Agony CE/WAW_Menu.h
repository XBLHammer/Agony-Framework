...
void BuildMenu()
{
	...
	addOption(&MenuVars, "Godmode", 0, 0, NULL, God);
	addOption(&MenuVars, "Noclip", 0, 0, NULL, Noclip);
	addOption(&MenuVars, "Give Weapons", 0, 0, NULL, GiveAll);
	addOption(&MenuVars, "Telekill", 0, 0, &bTeleKill);
	addOption(&MenuVars, "Add Bots", 0, 0, NULL, &addBots);
	addOption(&MenuVars, "Inf. Ammo", 0, 0, NULL, &InfAmmo);
